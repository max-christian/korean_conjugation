...
class Root(object):
    ...
    def index(self, infinitive='하다', regular=False, json=False, **everything_else):
        ...
        if json:
            return simplejson.dumps([u'', u'', u'<script>document.write("<a href=\"http://dongsa.net?infinitive=' + infinitive + '\">Click to conjugate!</a>");</script>'], ensure_ascii=False).encode('utf-8')
