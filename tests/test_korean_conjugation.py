...
def test_type():
    assert verb_type(u'낫다')   == u'ㅅ 불규칙 (irregular)'
    assert verb_type(u'모르다') == u'ㄹ 불규칙 (irregular)'
    assert verb_type(u'까맣다') == u'ㅎ 불규칙 (irregular)'
    assert verb_type(u'춥다')   == u'ㅂ 불규칙 (irregular)'
    assert verb_type(u'캐묻다') == u'ㄷ 불규칙 (irregular)'
    assert verb_type(u'알다')   == u'regular'
